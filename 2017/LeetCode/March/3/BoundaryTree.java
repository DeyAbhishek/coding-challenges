...
public class BoundaryTree {
    public List<Integer> boundaryOfBinaryTree(TreeNode root) {
        ...
        if (root.left != null) { //then record the whole left path either straight or winding
            while (current != null) {
        ...
        } else {  // then just record root and the left most LEAF node in the right subtree (if any)
            left.add(current.val);
            visited.add(current);
